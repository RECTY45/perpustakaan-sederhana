...
$anggota_list = mysqli_fetch_all($anggota_result, MYSQLI_ASSOC);

// Dapatkan ID buku dari URL jika ada
$id_buku = isset($_GET['id']) ? $_GET['id'] : '';

// Inisialisasi variabel untuk menyimpan judul buku
$selected_book_title = '';

// Periksa apakah ID buku tersedia
if ($id_buku) {
    // Buat kueri untuk mengambil judul buku berdasarkan ID
    $selected_book_query = "SELECT judul FROM buku WHERE id_buku = '$id_buku'";
    
    // Jalankan kueri dan simpan hasilnya
    $selected_book_result = mysqli_query($koneksi, $selected_book_query);
    
    // Periksa apakah ada baris yang dikembalikan oleh kueri
    if ($selected_book_row = mysqli_fetch_assoc($selected_book_result)) {
        // Jika ada, ambil judul buku dari hasil kueri
        $selected_book_title = $selected_book_row['judul'];
    }
}
?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="tanggal_peminjaman" value="<?php $tanggal_peminjaman ?>" name="tanggal_peminjaman" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="tanggal_wajib_dikembalikan">Tanggal Wajib Dikembalikan</label>
                                            <input type="date" class="form-control" id="tanggal_wajib_dikembalikan" name="tanggal_wajib_dikembalikan" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="pinjam_berapa_hari" name="pinjam_berapa_hari" placeholder="Masukkan Durasi Pinjam dalam Hari..." required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="catatan_perpustakaan">Catatan Perpustakaan</label>
                                            <textarea class="form-control" id="catatan_perpustakaan" name="catatan_perpustakaan" placeholder="Masukkan Catatan Perpustakaan..."></textarea>
                                        </div>
                                    </div>
                                </div>
