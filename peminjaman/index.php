                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img class="rounded img-fluid avatar-40 me-3 bg-soft-primary" src="../assets/images/cover/<?php echo htmlspecialchars($row['cover_buku']) ?>" alt="profile">
                                                                <h6><?php echo ($row['judul_buku']) ?></h6>
                                                            </div>
                                                        </td>
                                                        <td><?php echo $row['tanggal_peminjaman']; ?></td>
                                                        <td><?php echo $row['tanggal_wajib_dikembalikan']; ?></td>
                                                        <td><?php echo $row['tanggal_kembali'] ?? 'Buku Belum Kembali..'; ?></td>
                                                        <td><?php echo $row['status_peminjaman']; ?></td>
                                                        <td><?php echo $row['pinjam_berapa_hari']; ?></td>
                                                        <td><?php echo $row['perpanjangan_peminjaman'] ?? 'Belum ada..'; ?></td>
                                                        <td><?php echo $row['status_denda']; ?></td>
                                                        <td><?php echo $row['catatan_perpustakaan']; ?></td>
                                                        <td>  <div class="d-flex justify-content-between gap-2">
                                                                <a class="btn btn-outline-success btn-sm" href="../peminjaman/edit.php?id=<?php echo $row['id_peminjaman']; ?>">
                                                                ...
                                                                <a class="btn btn-outline-danger btn-sm" href="../peminjaman/hapus.php?id=<?php echo $row['id_peminjaman']; ?>">
