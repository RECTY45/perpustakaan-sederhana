<?php
include "countAnggota.php";
include "countBuku.php";
include "countPeminjaman.php";
?>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="flex-wrap d-flex justify-content-between align-items-center">
                        <div>
                           <h1>Halo Broo!</h1>
                           <p>Selamat Datang Di Website Perpusatakaan </p>
                        </div>
                     </div>
                  </div>
               </div>
                        ...
                        <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                           <div class="card-body">
                              <div class="progress-widget">
                                 <div id="circle-progress-01" class="text-center circle-progress-01 circle-progress circle-progress-primary" data-min-value="0" data-max-value="100" data-value="<?php echo $totalData ?>" data-type="percent">
                                 ...
                                 <div class="progress-detail">
                                    ...
                                    <h4 class="counter"><?php echo $totalData ?></h4>
                                 </div>
                              </div>
                           </div>
                        </li>
                        ...
                        <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="800">
                           <div class="card-body">
                              <div class="progress-widget">
                                 ...
                                 <div class="progress-detail">
                                    <p class="mb-2">Buku</p>
                                    <h4 class="counter"><?php echo $Buku ?></h4>
                                 </div>
                              </div>
                           </div>
                        </li>
                           ...
                           <div class="card-body">
                              <div class="progress-widget">
                                 ...
                                 <div class="progress-detail">
                                    ...
                                    <h4 class="counter"><?php echo $Peminajaman ?></h4>
                                 </div>
                              </div>
                           </div>
                        </li>
                  ...
                  ?>
                        <div class="col-md-3 mb-4">
                           <div class="card h-100 shadow">
                              <img src="../assets/images/cover/<?php echo $gambar; ?>" class="card-img-top" alt="Cover Buku">
                              <div class="card-body">
                                 <h5 class="card-title"><?php echo $judul; ?></h5>
                                 <p class="card-text">Penulis: <?php echo $penulis; ?></p>
                                 <p class="card-text">Tahun Terbit: <?php echo $tahun_terbit; ?></p>
                                 <p class="card-text">ISBN: <?php echo $isbn; ?></p>
                              </div>
                              <div class="card-footer bg-transparent border-top-0">
                                 <a href="../peminjaman/peminjaman.php?id=<?php echo $id; ?>" class="btn btn-primary btn-block">Pinjam</a>
                              </div>
                           </div>
                        </div>
                  <?php
