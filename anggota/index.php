                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a class="btn btn-primary rounded-pill" href="../anggota/tambah.php">
                                ...
                                <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap5">
                                    <div class="table-responsive border-bottom my-3">
                                        <table id="datatable" class="table table-striped dataTable" data-toggle="data-table" aria-describedby="datatable_info">
                                            <thead>
                                                <tr>
                                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 251.5px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">Nama Anggota</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 386.283px;" aria-label="Position: activate to sort column ascending">Alamat</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 198.517px;" aria-label="Office: activate to sort column ascending">No.Telp</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 80.7667px;" aria-label="Age: activate to sort column ascending">Email</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 80.7667px;" aria-label="Age: activate to sort column ascending">Jenis Kelamin</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 80.7667px;" aria-label="Age: activate to sort column ascending">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php foreach ($items as $anggota) : ?>
                                                    <!-- htmlspecialchars di gunakan untuk mencegah terjadinya serangan XSS 
                                                    yang mengubah karakter menjadi  TAG HTML -->
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlspecialchars($anggota['jenis_kelamin'] == 0 ? 'Laki-Laki' : 'Perempuan'); ?></td>
                                                        <td>
                                                            <div class="d-flex justify-content-between gap-2">
                                                                <a class="btn btn-outline-success btn-sm" href="../anggota/edit.php?id=<?php echo $anggota['id_anggota']; ?>">
                                                                    <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                <a class="btn btn-outline-danger btn-sm" href="../anggota/hapus.php?id=<?php echo $anggota['id_anggota']; ?>">
                                                                    <span class="btn-inner">
                                                                        <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
