<?php include('../config/koneksi.php');
 // Ambil id Anggota dari URL jika ada
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="header-title">
                                <h4 class="card-title">Sunting Anggota</h4>
                            </div>

                            <a class="btn btn-primary rounded-pill" href="../anggota">
                        ...
                        <div class="card-body">
                            <p>Sunting data anggota.</p>
                            <form action="../anggota/proses_edit.php" method="POST">
                            <input type="hidden" name="id" value="<?php echo $data['id_anggota'] ?>" sip>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="nama">Nama</label>
                                            <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $data['nama'] ?>" placeholder="Masukkan Nama Anda...">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="alamat">Alamat</label>
                                            <input type="text" class="form-control" id="alamat" name="alamat"  value="<?php echo $data['alamat'] ?>" placeholder="Masukkan Alamat Anda...">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="no_telp" name="no_telp" value="<?php echo $data['no_telp'] ?>" placeholder="Masukkan Nomor Telepon Anda...">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="email">Email</label>
                                            <input type="email" class="form-control" id="email" name="email"  value="<?php echo $data['email'] ?>" placeholder="Masukkan Email Anda...">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check form-check-inline">
                                            ...
                                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="inlineRadio1" value="0" <?php echo $data['jenis_kelamin'] == 0 ? 'checked' : '' ?> >
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-label">Perempuan</label>
                                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="inlineRadio2" value="1" <?php echo $data['jenis_kelamin'] == 1 ? 'checked' : '' ?>>
                                        </div>
                                    </div>
                                    </div>
                                </div>
