                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="../anggota/proses_tambah.php" method="POST">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="no_telp" name="no_telp" placeholder="Masukkan Nomor Telepon Anda...">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check form-check-inline">
                                            ...
                                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="inlineRadio1" value="0" required>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-label">Perempuan</label>
                                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="inlineRadio2" value="1" required>
                                        </div>
                                    </div>
                                    </div>
                                </div>
