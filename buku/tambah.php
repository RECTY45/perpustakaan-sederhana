            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>Tambah data .</p>
                            <form action="../buku/proses_tambah.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <label class="form-label" for="basic-default-company">Genre Buku</label>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check form-check-inline">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="genre[]" value="Fantasi" id="Fantasi">
                                        </div>
                                        <div class="form-check form-check-inline">
                                        ...
                                        <div class="form-check form-check-inline">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="genre[]" value="Komedi" id="Komedi">
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label" for="Psikologi">Psikologi</label>
                                            <input class="form-check-input" type="checkbox" name="genre[]" value="Psikologi" id="Psikologi">
                                        </div>
                                    </div>
                                </div>
